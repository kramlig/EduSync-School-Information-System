...
const Dashboard: React.FC<DashboardProps> = ({ schoolData }) => {
  const { students, courses, grades, isSyncing } = schoolData;
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card title="Total Courses" value={courses.length.toString()} icon={<BookOpenIcon />} />
      ...
      <div className="mt-8 bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
        ...
        <p className="text-slate-600 dark:text-slate-300">
          This is your central hub for managing school information. You can navigate using the sidebar to view students, manage courses, and record grades.
