  ...
  const staffNavGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/analytics', label: 'Analytics', icon: <ChartPieIcon />, roles: ['superadmin', 'admin'], badge: null },
        { path: '/settings', label: 'Settings', icon: <CogIcon />, roles: ['admin'], badge: null },
        { path: '/settings/billing', label: 'Billing & Subscription', icon: <CreditCardIcon />, roles: ['superadmin', 'admin'], badge: null },
