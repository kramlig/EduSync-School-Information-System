...
export default function PersonalHomeroomGuidance({ schoolId, teacherId, tier: _tier }: Props) {
  ...
  }, [schoolId, selectedSectionId, schoolYear]);
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-3">
        ...
        {advisorySections.length === 0 ? (
          <p className="text-sm text-amber-600 dark:text-amber-400">
            You are not an adviser of any section. Homeroom guidance is managed by the section adviser.
          </p>
        ) : (
          <select
